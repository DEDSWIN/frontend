    ...
    return (
        <div className={styles.parentcontainer}>
            ...
            <div className={styles.sec}>
                ...
                <p className={styles.para}>
                    Anwesha reserves the right to monitor all Comments and to
                    remove any Comments which can be considered inappropriate,
                    offensive or causes breach of these Terms and Conditions.
                </p>

                <p className={styles.para}>You warrant and represent that:</p>
                ...
                <p className={styles.para}>
                    You hereby grant Anwesha a non-exclusive license to use,
            ...
            <div className={styles.sec}>
                ...
                <ul className={styles.list}>
                    <li className={styles.listitem}>
                        <p className={styles.para}>Government agencies;</p>
                    </li>
                    <li className={styles.listitem}>
                        <p className={styles.para}>Search engines;</p>
                    </li>
                    <li className={styles.listitem}>
                ...
                <p className={styles.para}>
                    ...
                    compensates the absence of Anwesha; and (d) the link is in
                ...
                <p className={styles.para}>
                    ...
                    inform us by sending an e-mail to Anwesha. Please include
                ...
                <p className={styles.para}>
                    No use of Anwesha's logo or other artwork will be allowed
            ...
            <div className={styles.sec}>
                ...
                <p className={styles.para}>Please read Privacy Policy</p>
            </div>
            <div className={styles.sec}>
                <h3 className={styles.subheading}>
