        ...
        >
            ...
            <div className={styles.sec}>
                ...
                <p className={styles.para}>
                    ...
                    information that they shared and/or collect in anwesha.live.
            ...
            <div className={styles.sec}>
                ...
                <p className={styles.para}>
                    anwesha.live follows a standard procedure of using log
            ...
            <div className={styles.sec}>
                ...
                <p className={styles.para}>
                    Like any other website, anwesha.live uses 'cookies'. These
            ...
            <div className={styles.sec}>
                ...
                <p className={styles.para}>
                    ...
                    each of the advertising partners of anwesha.live.
                </p>
                ...
                <p className={styles.para}>
                    ...
                    anwesha.live, which are sent directly to users' browser.
                ...
                <p className={styles.para}>
                    Note that anwesha.live has no access to or control over
            ...
            <div className={styles.sec}>
                ...
                <p className={styles.para}>
                    anwesha.live's Privacy Policy does not apply to other
            ...
            <div className={styles.sec}>
                ...
                <p className={styles.para}>
                    anwesha.live does not knowingly collect any Personal
