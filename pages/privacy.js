        ...
        >
            ...
            <div className={styles.sec}>
                <p className={styles.para}>
                    At anwesha.iitp.ac.in, accessible from https://anwesha.iitp.ac.in, one
                    of our main priorities is the privacy of our visitors. This
                    Privacy Policy document contains types of information that
                    is collected and recorded by anwesha.iitp.ac.in and how we use it.
                </p>
                ...
                <p className={styles.para}>
                    ...
                    information that they shared and/or collect in anwesha.iitp.ac.in.
            ...
            <div className={styles.sec}>
                ...
                <ul className={styles.list}>
                    ...
                    <li className={styles.listitem}>Send you emails</li>
                    <li className={styles.listitem}>Find and prevent fraud</li>
                </ul>
            </div>
            <div className={styles.sec}>
                <h2 className={styles.subheading}>Log Files</h2>

                <p className={styles.para}>
                    anwesha.iitp.ac.in follows a standard procedure of using log
            ...
            <div className={styles.sec}>
                <h2 className={styles.subheading}>Cookies and Web Beacons</h2>

                <p className={styles.para}>
                    Like any other website, anwesha.iitp.ac.in uses 'cookies'. These
            ...
            <div className={styles.sec}>
                ...
                <p className={styles.para}>
                    ...
                    each of the advertising partners of anwesha.iitp.ac.in.
                </p>
                ...
                <p className={styles.para}>
                    ...
                    anwesha.iitp.ac.in, which are sent directly to users' browser.
                ...
                <p className={styles.para}>
                    Note that anwesha.iitp.ac.in has no access to or control over
            ...
            <div className={styles.sec}>
                ...
                <p className={styles.para}>
                    anwesha.iitp.ac.in's Privacy Policy does not apply to other
            ...
            <div className={styles.sec}>
                <h2 className={styles.subheading}>Children's Information</h2>
                ...
                <p className={styles.para}>
                    anwesha.iitp.ac.in does not knowingly collect any Personal
