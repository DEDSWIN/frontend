        ...
        <div className={styles.bg}>
            ...
            <section className={styles.events}>
                ...
                <div className={styles.events_button}>
                    <button className={cn(styles.sexy_button, styles.sexy_button_small)}>VIEW MORE</button>
                </div>
            </section>
            ...
            <section className={styles.merch} id="merch">
                <div className={styles.merch_body}>
                    ...
                    <p>
                        The designs are a fusion of elegance and innovation, capturing the true spirit of Anwesha.
                        T-shirts are made of supreme quality with GSM 200 and 100% cotton, ensuring maximum comfort and durability.
                        Hoodies are made from Premium Quality Woven Cotton with 350+ GSM cloth.
                    </p>
                </div>
                <div className={styles.merch_hero}>
                    ...
                    <div className={styles.merch_hero_fix}>
                        ...
                        <div className={styles.merch_button}>
                            <button className={styles.sexy_button}>GRAB NOW</button>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className={styles.moments}>
                ...
                <div className={styles.moments_button}>
                    <button className={styles.bat_scroll_button}
            ...
            <section className={styles.aftermovie}>
                ...
                <div className={styles.aftermovie_video}>
                    <Image src='/pics/aftermovie.jpg' width={1226} height={607} />
                </div>
            </section>
                ...
                <div className={styles.cta_body}>
                    <div className={styles.cta_body_left}>
                        ...
                        <div className={styles.cta_image}>
                            <Image src={"/pics/Mascot.png"} width={474.386} height={474.386} />
                        </div>
                    </div>
                    <div className={styles.cta_body_right}>
                        <p>
                            Meet <span>Grimmy</span>, a lone skeleton wandering the Abyss, where whispers of forgotten souls linger. In this realm of shadows and echoes, he unravels haunting secrets, braving eerie landscapes and unseen terrors. Join Grimmy as he dares to uncover the mysteries buried in the depths of the Abyss!
                            <br />
                            <br />
                            Join Grimmy on this fun adventure and let your imagination soar beyond the ordinary!
                        </p>
